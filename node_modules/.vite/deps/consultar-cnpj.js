...
// node_modules/consultar-cnpj/package.json
var require_package2 = __commonJS({
  "node_modules/consultar-cnpj/package.json"(exports, module) {
    module.exports = {
      name: "consultar-cnpj",
      version: "1.0.15",
      description: "Pacote para consulta de dados de empresas atrav\xE9s do CNPJ",
      main: "src/index.js",
      scripts: {
        test: "jest"
      },
      ...
      author: "Carlos Tirabassi Jr <carlos@bitize.com.br>",
      license: "MIT",
      dependencies: {
        axios: "^0.21.1"
      },
      repository: {
        type: "git",
        url: "git+https://github.com/cnpj-ws/consultar-cnpj.git"
      },
      devDependencies: {
        dotenv: "^10.0.0",
        jest: "^27.0.6"
...
// node_modules/consultar-cnpj/src/index.js
var require_src = __commonJS({
  "node_modules/consultar-cnpj/src/index.js"(exports, module) {
    var axios = require_axios2().default;
    var pjson = require_package2();
    module.exports = (cnpj, token) => {
      if (!cnpj)
        throw new Error("CNPJ n\xE3o informado");
    ...
    module.exports.raiz = (raiz, token, options = { page: 1 }) => {
      if (!raiz)
        throw new Error("Raiz do CNPJ n\xE3o informada");
      if (!token)
    ...
    module.exports.pesquisa = (filtros = null, token, page = 1) => {
      if (!token)
        throw new Error("Token n\xE3o informado");
      if (!filtros)
        throw new Error("Filtros n\xE3o informados");
      return new Promise((resolve, reject) => {
    ...
    module.exports.suframa = (cnpj, inscricao, token) => {
      if (!cnpj)
        throw new Error("CNPJ n\xE3o informado");
      if (!inscricao)
        throw new Error("Inscri\xE7\xE3o n\xE3o informada");
      cnpj = cnpj.replace(/[^0-9]/g, "");
...
//# sourceMappingURL=consultar-cnpj.js.map
